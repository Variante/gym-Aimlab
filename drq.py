...
class Actor(nn.Module):
    ...
    def __init__(self, obs_shape, action_shape, hidden_dim, hidden_depth, feature_dim,
                 log_std_bounds):
        super().__init__()
...
class DRQAgent(object):
    ...
    def __init__(self, obs_shape, action_shape, action_range, device,
                 hidden_dim, feature_dim, discount,
        ...
        self.actor = Actor(obs_shape, action_shape, hidden_dim, hidden_depth, feature_dim,
                 log_std_bounds).to(self.device)

        self.critic = Critic(obs_shape, action_shape, hidden_dim, hidden_depth, feature_dim).to(self.device)
        self.critic_target = Critic(obs_shape, action_shape, hidden_dim, hidden_depth, feature_dim).to(self.device)
        ...
        self.pre = T.CenterCrop(obs_shape[-1])
